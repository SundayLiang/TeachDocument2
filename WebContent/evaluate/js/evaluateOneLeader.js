...
function loadElement(a){
    ...
    temp += '<tr> <td align="center" width="100" height="40"><font size="3">评价内容(上传您的问卷pdf文件)：</font></td> <td colspan="2" align="center" width="100" height="80"><input id="content" type="file" name="content" formenctype="multipart/form-data"/></td> </tr> ' +
    '<tr> ' +
    '<td align="center" width="100" height="40"><font size="3">最终等级：</font></td> ' +
    '<td colspan="2" align="center" width="100" height="80">' +
    ' <input type="radio" name="score" value="95">优秀（90-100）' +
    '<input type="radio" name="score" value="85">良好（80-90）' +
    '<input type="radio" name="score" value="75">一般（70-80）' +
    '<br/> <input type="radio" name="score" value="65">及格（60-70）' +
    '<input type="radio" name="score" value="55">不及格（60以下）</td> </tr> <tr align="right"> <td colspan="3"> <input type="hidden"id="taskId" name="taskId" value="';
...
function evasub(){
    ...
    alert("请选择要上传的图片！");
        ...
        //var fromWhom = 1;
        //$.ajax({
        //    url: "/TeachDocument2/evaluateTables/insertLeaderEva",
        //    type: "post",
        //    dataType: "json",
        //    data: {
        //        "taskId":taskId,
