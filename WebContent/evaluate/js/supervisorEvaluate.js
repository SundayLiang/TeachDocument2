...
function showDetail(taskID) {
    parent.$("#mainFrame").attr("src", "evaluate/evaluateOneSuper.html?taskID='" + taskID+"'" );
}

function showOldDetail(taskId){
    parent.$("#mainFrame").attr("src", "evaluate/updateOneSuper.html?taskID='" + taskId+"'" );
}

function showReadOnly(taskId) {
    parent.$("#mainFrame").attr("src", "evaluate/readOnlySuper.html?taskID='" + taskId+"'");
}
